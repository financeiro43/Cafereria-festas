      ...
      <div className="min-h-screen bg-slate-50">
        <Dialog open={isLoginOpen} onOpenChange={setIsLoginOpen}>
          <nav className="p-6 flex justify-between items-center max-w-7xl mx-auto">
            ...
            <DialogTrigger render={<Button variant="outline" className="border-slate-200">Entrar</Button>} />
          </nav>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-10">
                <DialogTrigger render={
                  <Button size="lg" className="bg-slate-900 hover:bg-slate-800 text-white px-8 h-14 rounded-xl text-lg group">
              ...
              <div className="flex flex-col gap-3">
                ...
                >
                  <svg className="w-5 h-5" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" fill="#4285F4" />
